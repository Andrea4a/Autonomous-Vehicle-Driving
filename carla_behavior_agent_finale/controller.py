...
class VehicleController():
    ...
    def __init__(self, vehicle, args_lateral, args_longitudinal, offset=0, max_throttle=0.85, max_brake=0.3,
                 max_steering=0.8):
        """
        Constructor method.
...
class StanleyLateralController():
    ...
    def __init__(self, vehicle, offset=0, lookahead_distance=1.2, K_V=1.0, K_S=0.0, dt=0.03):
        """
        Constructor method.
...
class PIDLateralController():
    ...
    def __init__(self, vehicle, offset=0, K_P=1.5, K_I=0.05, K_D=0.2, dt=0.03):
        """
        Constructor method.
